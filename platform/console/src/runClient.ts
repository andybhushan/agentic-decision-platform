// Start + poll a Durable orchestration run for a claim.
...
export type RunStatusKind = "Pending" | "Running" | "Completed" | "Failed" | "Terminated" | "Canceled" | "Suspended" | "Unknown";
...
export interface RunStatus {
  ...
  result?: { traceId: string; subjectId: string; stepCount: number; hitlGatesOpen: number; completedAt: string };
  traceUrl?: string;
}
